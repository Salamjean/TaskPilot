...
@section('content')
    ...
    <div class="pi-header">
        ...
        <a href="{{ route($prefix . '.projects.create') }}" class="pi-btn-add">
    ...
    @if($projects->isEmpty())
        ...
        <div class="pi-empty">
            ...
            <a href="{{ route($prefix . '.projects.create') }}" class="pi-btn-add" style="margin-top:20px">
                Créer un projet
            </a>
        </div>
    @else
                        ...
                        <tr>
                            ...
                            <td class="td-right" style="display:flex; justify-content:center">
                                <div class="pc-actions">
                                    <a href="{{ route($prefix . '.projects.show', $project) }}" class="pc-action view"
                                    ...
                                    @if(in_array(auth()->user()->role, ['admin', 'responsable']))
                                        <button type="button" class="pc-action status btn-status-swal"
                                            data-action="{{ route($prefix . '.projects.status', $project) }}"
                                    ...
                                    @endif
                                    <a href="{{ route($prefix . '.projects.edit', $project) }}" class="pc-action edit"
                                        title="Modifier">
                                        <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                            stroke-width="2">
