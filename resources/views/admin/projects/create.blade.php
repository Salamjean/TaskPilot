...
@section('content')
    ...
    <div class="pf-layout">
        ...
        <div class="pf-main">
            ...
            {{-- Formulaire --}}
            <form method="POST" action="{{ route($prefix . '.projects.store') }}" class="pf-form" id="projectForm"
    ...
    <script>
        ...
        // Initialisation si on revient avec old('type')
        ...
        typeSelect.addEventListener('change', function () {
            if (this.value === 'autre') {
                ...
                // Remettre le texte "Autre" normal
                const autreOption = typeSelect.querySelector('option[value="autre"]');
