...
@section('content')
    ...
    <style>
        ...
        /* Card styles duplicated from index for consistency */
        .dl-grid {
            display: grid;
    ...
    <a href="{{ route($prefix . '.daily-logs.index') }}" class="back-btn">
    ...
    @if($todayLog)
        <div class="today-banner">
            <div style="display:flex; align-items:flex-start; justify-content:space-between;">
                ...
                'is_owner' => $todayLog->user_id === auth()->id(),
                'is_today' => true,
            ]) }})">
                    Voir les détails
                </button>
            ...
            <div style="display:flex; gap:15px;">
                @if($todayLog->file_path)
                    <a href="{{ Storage::url($todayLog->file_path) }}" target="_blank" class="dl-badge dl-badge-file"
                        style="padding:10px 20px; border-radius:12px; font-size:.85rem;">
