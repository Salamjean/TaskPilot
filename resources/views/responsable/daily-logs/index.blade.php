        ...
        <div class="dl-grid">
            @foreach($logs as $log)
                ...
                <div class="dl-card" onclick="window.location='{{ route($prefix . '.daily-logs.user-history', $log->user_id) }}'"
                    style="border-left: 4px solid {{ $log->date->isToday() ? '#047857' : '#94A3B8' }};">
                                                    ...
                                                    <div style="text-align:left;">
                                                        ...
                                                        ${log.file_url ? `
                                                            <div style="margin-top:16px; border-top:1px dashed #E5E7EB; padding-top:16px;">
                                                                ...
                                                                <a href="${log.file_url}" target="_blank" style="display:flex;align-items:center;gap:12px;background:#FFFBEB;padding:12px 16px;border-radius:12px;border:1px solid #FEF3C7;text-decoration:none;transition:transform .15s;">
                                                                    <div style="width:36px;height:36px;background:#fff;border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 6px rgba(0,0,0,.05);color:#D97706;">
                                                                        <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path d="M12 4v16m8-8H4"/></svg>
                                                                    </div>
                                                                     <div style="flex:1;">
                                                                         <div style="font-size:.88rem;color:#D97706;font-weight:700;">Consulter le document joint</div>
                                                                         <div style="font-size:.72rem;color:#B45309;opacity:.8;">Ouvrir dans un nouvel onglet</div>
                                                                     </div>
                                                                     <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="#D97706" stroke-width="2.5"><polyline points="9 18 15 12 9 6"/></svg>
                                                                 </a>
