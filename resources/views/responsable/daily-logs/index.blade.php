...
@section('content')
    ...
    @if($personnelList->isEmpty())
        <div
            ...
            <p style="font-weight:600;margin-bottom:4px;">Aucun personnel trouvé.</p>
            <p style="font-size:.83rem;">Aucun collaborateur ne correspond à vos critères de recherche.</p>
        </div>
    @else
        <div class="dl-grid">
            @foreach($personnelList as $user)
                ...
                <div class="dl-card" onclick="window.location='{{ route($prefix . '.daily-logs.user-history', $user->id) }}'"
                    style="border-left: 4px solid {{ $hasLogToday ? '#047857' : '#94A3B8' }};">
