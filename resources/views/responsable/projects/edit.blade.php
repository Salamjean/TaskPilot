...
@section('content')
    ...
    <div class="pf-layout">
        ...
        <div class="pf-main">
            ...
            <form method="POST" action="{{ route('responsable.projects.update', $project) }}" class="pe-form" id="editForm"
                ...
                <div class="pf-field {{ $errors->has('name') ? 'has-error' : '' }}">
                    ...
                    <div class="pf-input-wrap">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $project->name) }}" class="pf-input"
                            autocomplete="off" required style="padding-left: 40px !important;">
                    </div>
                    ...
                    <div class="pf-field {{ $errors->has('company') ? 'has-error' : '' }}">
                        ...
                        <div class="pf-input-wrap">
                            ...
                            <input type="text" id="company" name="company" value="{{ old('company', $project->company) }}"
                                class="pf-input" required style="padding-left: 40px !important;">
                        </div>
                ...
                <div class="pf-field">
                    ...
                    <textarea id="description" name="description" rows="5" class="pf-input pf-textarea"
                        style="padding-left: 14px !important;">{{ old('description', $project->description) }}</textarea>
                    <p class="pf-hint">
                ...
                <div class="pf-danger-zone">
                    ...
                    <form method="POST" action="{{ route('responsable.projects.destroy', $project) }}" id="deleteForm">
                        @csrf @method('DELETE')
...
@push('scripts')
    ...
    <script>
        ...
        const defaultSvg = logoPreview ? logoPreview.querySelector('svg') : null;
                ...
                if (this.value === 'autre') {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            // Revenir à la valeur précédente ou vide
                            typeSelect.value = typeHidden.value;
                        }
                    });
                } else {
