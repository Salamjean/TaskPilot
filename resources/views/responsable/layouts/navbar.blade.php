            ...
            <div class="profile-dropdown" id="notifDropdown"
                ...
                <div style="max-height: 350px; overflow-y: auto;">
                    @forelse(auth()->user()->notifications()->take(10)->get() as $notification)
                        <div
                            style="position: relative; border-bottom: 1px solid #F3F4F6; background: {{ $notification->read_at ? '#fff' : '#FFFBEB' }}; transition: background .15s;">
        ...
        <div class="profile-wrap" id="profileWrap">
            <button class="profile-btn" id="profileBtn" type="button">
                ...
                <div class="profile-info">
                    ...
                    <div class="profile-role">Responsable</div>
                </div>
